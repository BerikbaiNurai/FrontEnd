...
export default function HomeScreen({ navigation }: HomeScreenProps) {
  ...
  const stats = [
    { value: '42', label: 'Posts', userId: '123' },
    { value: '1.2K', label: 'Followers', userId: '123' },
    { value: '890', label: 'Following', userId: '123' },
  ];
          ...
          <View style={styles.statsSection}>
            {stats.map((stat, index) => (
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate('Profile', { userId: stat.userId })
                }
                activeOpacity={0.7}
              >
