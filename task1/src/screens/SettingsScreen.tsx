      ...
      <ScrollView>
        <View style={styles.section}>
          ...
          <View style={styles.sectionContent}>
            ...
            <SettingRow
              ...
              onPress={() => Alert.alert('Change Password', 'Change password screen would open')}
              showArrow
            />
            <SettingRow
              label="Privacy"
              onPress={() => Alert.alert('Privacy Settings', 'Privacy settings would open')}
              showArrow
            />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.sectionContent}>
            ...
            <SettingRow
              label="Contact Us"
              onPress={() => Alert.alert('Contact Us', 'Contact form would open')}
              showArrow
            />
            <SettingRow
              label="About"
        ...
        <View style={styles.navInfo}>
          <Text style={styles.navInfoText}>
            Press back button or swipe from left edge to return
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
