...
export default function NotificationsScreen() {
  ...
  const getNotificationIcon = (type: Notification['type']) => {
    switch (type) {
      case 'like':
        return { name: 'heart' as const, color: '#dc3545' as const };
      case 'comment':
        return { name: 'chatbubble' as const, color: '#0066cc' as const };
      case 'follow':
        return { name: 'person-add' as const, color: '#28a745' as const };
      case 'mention':
        return { name: 'at' as const, color: '#ffc107' as const };
    }
  };
